...
function Pikaboo(props: PikabooProps) {
    ...
    React.useLayoutEffect(() => {
        ...
        tl.to('#pikabooMain', { yPercent: -30 })
            ...
            .to('#lamp-light', { duration: 1, opacity: 0.2, repeat: -1, repeatDelay: 8, ease: "rough({ template: none.out, strength: 1, points: 20, taper: 'none', randomize: true, clamp:  false})" }, '<');
        ...
        function beingShy(e: any) {
            ...
            tl2.to("#arm-left", { duration: 0, opacity: 0 })
    ...
    return (
        <svg id="svg" viewBox="-133 0 1066 600" aria-labelledby="uniqueDescID" preserveAspectRatio="xMidYMin meet" role="img">
            ...
            <g id="background">
                ...
                <rect id="wood-shadow" x="-200" y="375" width="1200" height="14" opacity="0.3" style={{
                    mixBlendMode: 'multiply'
                }} />
                <rect id="wood-highlight" x="-200" y="361" width="1200" height="14" fill="#fff" opacity="0.58" style={{
            ...
            <g id="deco" clipPath="url(#backgroundClip)">
                ...
                <path id="deco-string" fill="none" stroke="#23152d" strokeMiterlimit="10" strokeWidth="5.67" d="M-274-3c79,118,263,258.36,445,148C265,88,263,0,266,0c0,0,24,75,104.5,75.5,106.79.66,116.29-78.24,123-76,12,4,20.06,129.59,144.5,157.5,107,24,204-3,411-159" />
                <g id="eye2">
                ...
                <g transform="translate(-200, 80) rotate(120)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(-110, 150) rotate(110)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(0, 185) rotate(90)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(170, 145) rotate(60)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(235, 80) rotate(40)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(330, 65) rotate(130)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(450, 55) rotate(65)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(540, 95) rotate(120)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(690, 165) rotate(90)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(795, 150) rotate(75)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(890, 105) rotate(60)"><use xlinkHref="#batPattern" /></g>
                <g transform="translate(990, 40) rotate(45)"><use xlinkHref="#batPattern" /></g>
            </g>
            <g id="lamp" clipPath="url(#backgroundClip)">
                <polygon id="lamp-light" opacity="0.4" fill="url(#lightGradient)" points="800 604 0 604 364 148 436 148 800 604" style={{
                    mixBlendMode: 'soft-light'
                }} />
            ...
            <g id="pikaboo">
                <g id="pikabooMain">
                    <path id="tail" d="M196,332c-9,2-26,12-27,7-2.19-11-2-45-10-48-4-1.49-57.6,18.18-60,31-3,16,15,52,23,52,9,0,24-26,28-25,5,1.24,3.89,18.7,9,17,6-2,25-12,40-26" fill="#fcdc55" stroke="#46777f" strokeMiterlimit="10" strokeWidth="5.67" />
                    <g id="ear-right">
                        <path d="M348,277c-10-27-14-74-5-74,14,0,34,52.85,42,95.13" fill="#fff" stroke="#46777f" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="5.67" />
                        <path d="M339,231c2,0,7-1,12,0,11,2.19,13,5,16,6-10.76-23.8-18.39-33-23-34C337.05,201.54,339,225,339,231Z" fill="#46777f" />
                    </g>
                    <path id="arm-left" opacity="1" d="M370,354c12.57-4.41,33.67-3.52,36,3,5,14-34.68,40.11-42,47" fill="#fff" stroke="#46777f" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="5.67" />
                    <g id="body">
                        ...
                        <path id="mounth" d="M349,334c3-4,6-8,8-8,3,0,3,3,5,6" fill="none" stroke="#46777f" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="3.97" />
                        <path id="body-stroke" d="M183,331.09c3.79-9.76,26.22-4.14,43.85-11.43,21.38-8.83,18.09-46.23,76.2-56.62,22.34-4,57.93-1,76.74,24.93,23.8,32.86,8.23,57.54,4.39,76.89C366.65,453.18,286.62,487.46,271.82,488c-3.63.13-12.9-.39-17.54-6.23-4-5.08-5.48-11.43-8.22-14-3.84-3.63-17.55,1-28.51-10.39-11.52-12-6-15.39-11-22.86-3.84-5.71-13.16,0-21.93-16.62-7.92-15,1.1-17.66-1.1-28.05-1.09-5.2-8.77-2.08-8.77-20.78,0-14.88,10.89-15.8,9.32-20.26C182.47,344.08,179.18,341,183,331.09Z" fill="none" stroke="#46777f" strokeMiterlimit="10" strokeWidth="5.67" />
                        ...
                        <g id="expression-afraid" opacity="0">
                            ...
                            <path id="arm-left-alt" d="M400,362c0-9.49-20.85-18.68-25-14a6.83,6.83,0,0,0-2,5c0,6.87,0,21,6.42,27,4.32,4,13.19,4.53,16.58,0C399,376,400,370,400,362Z" fill="#fff" stroke="#46777f" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="5.67" />
                        </g>
                    </g>
                    <path id="arm-right" d="M290,356c23.55-8.39,41.82-9.26,45-3,4.14,8.14-17.87,27.05-19,28" fill="#fff" stroke="#46777f" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="5.67" />
                    <g id="ear-left">
                        <path d="M257,295c-9-23.49-32-57.55-17-92.78,7.4-17.39,38.19,48.76,50,70.47" fill="#fff" stroke="#46777f" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="5.67" />
